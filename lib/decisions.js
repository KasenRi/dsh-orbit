...
export const WATCHDOG_HEARTBEAT_SCHEMA = {
    type: 'object',
    additionalProperties: false,
    required: ['decision'],
    properties: {
...
export const WATCHDOG_FINAL_AUDIT_SCHEMA = {
    type: 'object',
    additionalProperties: false,
    required: ['decision'],
    properties: {
...
export function assertHeartbeatDecision(decision) {
...
export function assertFinalAuditDecision(decision) {
