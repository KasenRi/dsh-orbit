...
> This repository is an installable release mirror for @kasenri/dsh-orbit 0.6.4.
...
```text
PLAN → EXECUTE → EVALUATE → CORRECT / RECOVER → FINAL_VERIFY → TERMINAL_CONFIRM → SUCCESS
```
